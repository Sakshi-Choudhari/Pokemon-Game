...
public class Main {
    ...
    private static Pokemon generateWildPokemon(Trainer player) {
        ...
        // Weedle
        Pokemon weedle = new Pokemon("Weedle", "Bug/Poison", 40, 35, 30, 20, 20, 50, random.nextInt(3) + 2, true);
        weedle.learnMove(new Move("Poison Sting", "Poison", 15, 100, "Physical", "May poison the target"), true);
        weedle.learnMove(new Move("String Shot", "Bug", 0, 95, "Status", "Lowers target's Speed"), true);
        wildPokemonList.add(weedle);

        // Geodude
        Pokemon geodude = new Pokemon("Geodude", "Rock/Ground", 40, 80, 100, 30, 30, 20, random.nextInt(3) + 4, true);
        geodude.learnMove(new Move("Tackle", "Normal", 40, 100, "Physical", null), true);
        geodude.learnMove(new Move("Rock Throw", "Rock", 50, 90, "Physical", null), true);
        wildPokemonList.add(geodude);

        //Growlithe
        Pokemon growlithe = new Pokemon("Growlithe", "Fire", 55, 70, 45, 70, 50, 60, random.nextInt(3) + 3, true);
        growlithe.learnMove(new Move("Ember", "Fire", 40, 100, "Special", null), true);
        growlithe.learnMove(new Move("Bite", "Dark", 60, 100, "Physical", null), true);
        wildPokemonList.add(growlithe);

        // Water-type wild Pokémon (strong against Fire, weak to Grass)
        Pokemon poliwag = new Pokemon("Poliwag", "Water", 40, 50, 40, 40, 40, 90, random.nextInt(3) + 3, true);
        poliwag.learnMove(new Move("Bubble", "Water", 40, 100, "Special", null), true);
        poliwag.learnMove(new Move("Hypnosis", "Psychic", 0, 60, "Status", "May put the target to sleep"), true);
        wildPokemonList.add(poliwag);

        // Grass-type wild Pokémon (strong against Water, weak to Fire)
        Pokemon oddish = new Pokemon("Oddish", "Grass/Poison", 45, 50, 55, 75, 65, 30, random.nextInt(3) + 3, true);
        oddish.learnMove(new Move("Absorb", "Grass", 20, 100, "Special", "Restores HP to the user"), true);
        oddish.learnMove(new Move("Acid", "Poison", 40, 100, "Special", "May lower target's Special Defense"), true);
        wildPokemonList.add(oddish);

        // Electric-type wild Pokémon (strong against Water)
        Pokemon pikachu = new Pokemon("Pikachu", "Electric", 35, 55, 40, 50, 50, 90, random.nextInt(3) + 3, true);
        pikachu.learnMove(new Move("Thunder Shock", "Electric", 40, 100, "Special", "May paralyze the target"), true);
        pikachu.learnMove(new Move("Quick Attack", "Normal", 40, 100, "Physical", null), true);
        wildPokemonList.add(pikachu);

        // Ground-type wild Pokémon (strong against Fire and Electric, weak to Water and Grass)
        Pokemon sandshrew = new Pokemon("Sandshrew", "Ground", 50, 75, 85, 20, 30, 40, random.nextInt(3) + 3, true);
        sandshrew.learnMove(new Move("Scratch", "Normal", 40, 100, "Physical", null), true);
        sandshrew.learnMove(new Move("Sand Attack", "Ground", 0, 100, "Status", "Lowers target's accuracy"), true);
        wildPokemonList.add(sandshrew);
        // Add more wild Pokémon as needed...
